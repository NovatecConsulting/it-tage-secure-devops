...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '8194d8f6-4ce4-4398-90fb-9a1f6783bf0a' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('fe679c5c-21d2-4250-983c-4006c430cba9');
      cy.get(`[data-cy="name"]`).should('have.value', 'fe679c5c-21d2-4250-983c-4006c430cba9');
